	...
	<form action="" id="manage-enroll">
		...
		<div class="form-group">
			...
			<select name="gender" id="gender" class="custom-select browser-default">
				<option value="male" <?php echo isset($meta['gender']) && $meta['gender'] == 'male' ? 'selected' : '' ?>>
					Male</option>
		...
		<div class="form-group">
			...
			<select name="type" id="type" class="custom-select browser-default">
				...
				<?php if (isset($_GET['id'])): ?>
					<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Regular
					</option>
				<?php endif; ?>
				<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Transferee
				</option>
				<?php if (isset($_GET['id'])): ?>
					<option value="4" <?php echo isset($meta['type']) && $meta['type'] == 4 ? 'selected' : '' ?>>Returnee
					</option>
				<?php endif; ?>
			</select>
		</div>
