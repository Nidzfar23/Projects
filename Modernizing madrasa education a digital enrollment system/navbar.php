...
<nav id="sidebar" class='mx-lt-5 bg-light' style="background-color: #007b94 !important;">
	<div class="container-fluid" style="padding: 0">
		...
		<div class="sidebar-list">
			...
			<a href="index.php?page=official" class="nav-item" onclick="changeStyles(this)">
				<span class='icon-field'><i class="fa fa-users"></i></span> Official List
			</a>
			...
			<a href="#settings-collapse" role="button" aria-expanded="false" aria-controls="settings-collapse"
				class="nav-item nav-level_section nav-school_year " data-toggle="collapse"><span class='icon-field'><i
