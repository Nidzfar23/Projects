								...
								<div class="col-md-12">
									...
									<form method="POST">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="Enter Here.." id="catename"
												name="catename" required>
										</div>


										<div class="form-group">
											<label>Short Description</label>
											<input type="text" class="form-control" placeholder="Enter Here.." id="sdesc"
												name="sdesc" required>
										</div>
