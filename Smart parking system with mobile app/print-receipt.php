    ...
    while ($row = mysqli_fetch_array($ret)) {
      ...
      <div id="exampl" style="margin-top: 30px">
        <table id="dom-jqry" class="table table-striped table-bordered">
          <tr>
            <th colspan="4" style="text-align: center; font-size:22px;"> Smart Parking System Receipt</th>
          </tr>
          ...
          <tr>
            ...
            <td colspan="4" style="text-align:center;">
              ...
              $picturePath = "user/img/" . $pictureName; // Assuming images are in the "img" directory
            
              // Check if the file exists before displaying the image
              if (file_exists($picturePath)) {
                echo "<img src='$picturePath' alt='Parking Lot Picture' height='450' width='600'>";
              } else {
