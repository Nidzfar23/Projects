								...
								<tbody>
									...
									while ($row = mysqli_fetch_array($ret)) {
										...
										<tr>
											...
											<td>
												<?php echo $row['VehicleCompanyname']; ?>
											</td>
											...
											<td><a href="outgoing-detail.php?updateid=<?php echo $row['ID']; ?>"><button
														type="button" class="btn btn-sm btn-info">View Details</button></a>
												<a href="print-receipt.php?vid=<?php echo $row['ID']; ?>"><button type="button"
														class="btn btn-sm btn-warning"> <i class="fa fa-print"></i></button>

													<a href="remove-outgoing.php?editid=<?php echo $row['ID']; ?>"> <button
