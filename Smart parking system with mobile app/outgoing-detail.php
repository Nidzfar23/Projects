							...
							while ($row = mysqli_fetch_array($ret)) {
								...
								?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control"
												value="<?php echo $row['VehicleCompanyname']; ?>" id="sdesc" name="sdesc"
												readonly>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $row['ParkingNumber']; ?>"
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $row['OutTime']; ?>"
												id="sdesc" name="sdesc" readonly>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $row['OwnerName']; ?>"
												id="sdesc" name="sdesc" readonly>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control"
												value="<?php echo $row['OwnerContactNumber']; ?>" id="sdesc" name="sdesc"
												readonly>
										</div>
										...
										<div class="form-group">
											...
											<input type="hidden" class="form-control"
												value="$ <?php echo $row['ParkingCharge']; ?>" id="parkingcharge"
												name="parkingcharge" readonly>
										</div>
										...
										<div class="form-group">
											...
											<input type="hidden" class="form-control" value="<?php echo $row['Remark']; ?>"
												id="remark" name="remark" readonly>
										</div>
