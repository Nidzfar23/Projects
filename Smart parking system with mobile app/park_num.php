            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Parking Lot <a href="add-parking.php" type="button"
                                class="btn btn-sm btn-primary">Add New Parking Lot</a></div>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) {
                                        ...
                                        <tr>
                                            ...
                                            $statusText = ($status == 1) ? 'Available' : 'Occupied';
                                            ?>
