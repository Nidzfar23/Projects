...
<!-- Navbar -->
<nav
  class="main-header navbar navbar-expand navbar-dark border border-light border-top-0  border-left-0 border-right-0 navbar-light text-lg font-weight-bold pb-4"
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item">
      <div class="btn-group nav-link">
        <button type="button" class="btn btn-rounded badge badge-info dropdown-toggle dropdown-icon"
          ...
          <span class="ml-3">
            <?php echo ucwords($_settings->userdata('firstname')) ?>
          </span>
