...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    $qry = $conn->query("SELECT * from `guide` where id = '{$_GET['id']}' ");
    if ($qry->num_rows > 0) {
...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title">
            <?php echo isset($id) ? "Update " : "Create New " ?> Tour Guide
        </h3>
    </div>
    <div class="card-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#car-form').submit(function (e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_guide",
