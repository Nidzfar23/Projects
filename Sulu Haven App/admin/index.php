...
<body style="background-color: #d1fbff;"
  class="layout-fixed layout-footer-fixed text-sm sidebar-mini control-sidebar-slide-open layout-navbar-fixed text-dark"
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="background-color: #d1fbff; ">
      ...
      <div class="content-header pt-5">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h1 class="m-0">
                <?php echo ucwords(str_replace(array("/", "_"), " ", $page)) ?>
              </h1>
            </div>
            <!-- /.col -->
            <!-- <div class="col-sm-6">
      ...
      <!-- /.content-header -->
      <!-- Main content -->
      <section class="content text-dark mb-5" style="background-color: #d1fbff; height: 600px;">
