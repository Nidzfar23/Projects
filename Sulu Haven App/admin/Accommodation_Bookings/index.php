...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Accommodation Bookings</h3>
        ...
        <div class="container-fluid">
            <table class="table table-stripped text-dark">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT b.*,p.title,concat(u.firstname,' ',u.lastname) as name FROM book_list b inner join `accom` p on p.id = b.accom_id inner join users u on u.id = b.user_id order by date(b.date_created) desc ");
                            ...
                            <td align="center">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item view_data" href="javascript:void(0)"
                                        data-id="<?php echo $row['id'] ?>"><span class="fa fa-file text-primary"></span>
                                        View</a>
...
<script>
    $(document).ready(function () {
        ...
        $('.view_data').click(function () {
            uni_modal("Booking Information", "Accommodation_Bookings/view.php?id=" + $(this).attr('data-id'))
        })
        $('.table').dataTable();
    })
