...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Car Bookings</h3>
        ...
        <div class="container-fluid">
            <table class="table table-stripped text-dark">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT b.*,p.title,concat(u.firstname,' ',u.lastname) as name FROM book_list b inner join `rent` p on p.id = b.car_id inner join users u on u.id = b.user_id order by date(b.date_created) desc ");
...
<script>
    $(document).ready(function () {
        ...
        $('.view_data').click(function () {
            uni_modal("Booking Information", "bookcar/view.php?id=" + $(this).attr('data-id'))
        })
        $('.table').dataTable();
    })
