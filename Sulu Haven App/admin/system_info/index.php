		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<textarea name="privacy_policy" id="" cols="30" rows="2"
						class="form-control summernote"><?php echo is_file(base_app . 'privacy_policy.html') ? file_get_contents(base_app . 'privacy_policy.html') : "" ?></textarea>
				</div>
