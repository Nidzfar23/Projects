                        ...
                        <form enctype="multipart/form-data" method="post" action="saveuser7.php" autocomplete="off">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo $details['chargespm']; ?>"
                                                name="chargespm" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo $details['chargespd']; ?>"
                                                name="chargespd" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <div class="text-right">
                                        <button type="submit" name="submit" class="btn btn-info">UPADTE
                                            CATEGORY</button>
