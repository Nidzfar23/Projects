                        ...
                        <form enctype="multipart/form-data" method="post" action="" autocomplete="off">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" title="What is the name of this cartegory? " name="name"
                                                id="text" required class="form-control"
                                                placeholder="Enter the name of the category you are registering">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="number" title="What is the amount of this category? "
                                                name="chargespm" id="text" required class="form-control"
                                                placeholder="Enter the amount of the category per month">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" title="What is the amount of this cartegory? "
                                                name="chargespd" id="text" required class="form-control"
                                                placeholder="Enter the amount of the cartegory per collection">
                                        </div>
                                    </div>
                                </div>
