    ...
    <div class="row">
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="reg.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="results.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="orders.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="hometherapy.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="transport.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="ewallet.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="emergency.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="covid.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background: rgb(1, 202, 241);">
                <a href="appoint.php?user=<?php echo $_SESSION['username']; ?>">
                    <div class="card-body">
